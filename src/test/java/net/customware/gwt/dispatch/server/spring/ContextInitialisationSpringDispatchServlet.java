 ...
 * 
 */
public class ContextInitialisationSpringDispatchServlet extends SpringStandardDispatchServlet {

    private static final long serialVersionUID = 1L;
    
    private final ContextLoaderServlet servlet = new PredefinedContextLocationContextLoaderServlet("classpath:/dispatch-test.xml");
